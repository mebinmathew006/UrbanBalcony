...
urlpatterns = [
    ...
    path('filterBasedProductData',FilterBasedProductData.as_view(),name='filterBasedProductData'),
    path('searchBasedProductData/<str:search_term>',SearchBasedProductData.as_view(),name='searchBasedProductData'),
    ...
    path('otp',ResendOTP.as_view(),name='resendotp'), 
    ...
    path('reviewAndRating',AddReviewAndRating.as_view(),name='ReviewAndRatings'),
