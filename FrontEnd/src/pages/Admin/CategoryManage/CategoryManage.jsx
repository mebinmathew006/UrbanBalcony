          ...
          <div className="d-flex flex-column flex-grow-1">
            <main className="bg-light">
              <div className="container-fluid">
                ...
                <button className="btn btn-info" onClick={()=>navigate('/CategoryAdd')}>ADD</button></div>
                    ...
                    {category &&
                      category.map((category, index) => (
                        <tr key={index}>
                          ...
                          <td ><button className="btn btn-success"  onClick={()=>navigate('/CategoryUpdate',{state:category})}>Edit</button></td>
                        </tr>
                      ))}
                  </tbody>
                </table>
