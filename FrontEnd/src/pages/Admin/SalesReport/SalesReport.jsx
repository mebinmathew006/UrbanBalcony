...
import { Calendar, Download, TrendingUp, ShoppingCart, DollarSign } from 'lucide-react';
import DatePicker from 'react-datepicker';
import 'react-datepicker/dist/react-datepicker.css';
import Sidebar from '../../../components/Admin/Sidebar/Sidebar';
import adminaxiosInstance from '../../../adminaxiosconfig';
import Papa from 'papaparse';import jsPDF from 'jspdf';
...
function SalesReport() {
  ...
  //   try {
  //     const response = await adminaxiosInstance.get('/exportSalesReportView', {
  //       params: {
  //         startDate: startDate.toISOString(),
  //         endDate: endDate.toISOString()
  //       },
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="bg-white p-4 rounded-lg shadow-sm flex items-center">
          ...
          <div>
            ...
            <p className="text-xl font-bold">₹{salesData.totalRevenue.toLocaleString()}</p>
          </div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow-sm flex items-center">
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm flex items-center">
          ...
          <div>
            ...
            <p className="text-xl font-bold">₹{salesData.averageOrderValue.toLocaleString()}</p>
          </div>
        </div>
      </div>
